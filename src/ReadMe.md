...
This project implements a plagiarism detection system using Natural Language Processing (NLP) techniques. It provides both a command-line interface and a JavaFX graphical application. The checker analyzes two documents using semantic and lexical similarity methods and produces a detailed HTML report including matched phrases and a semantic heatmap.
